...
<html lang="en" dir="ltr">
    ...
    <body>
        <%if (request.getAttribute("USER_LIST") == null) {
                response.sendRedirect("MainController?action=Search&type=HR Manager&search=");
            }%>
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="MainController?type=HR Manager&action=Search&search=" class="active">
                        <i class='bx bx-user' ></i>
        ...
        <section class="home-section">
            <nav>
                ...
                <form action="MainController"class="search-box">
                    <div>
                        <input type="hidden" name="type" value="HR Manager">
            ...
            <div class="home-content">
                ...
                <div class="sales-boxes">
                    <div class="recent-sales box">
                        <div class="title" style="float:left">HR MANAGER</div>
                        <a href="adminAddUserPage.jsp?type=HR Manager"style="float:right" >
