...
<html lang="en">
    ...
    <body>
        ...
        <% if (request.getParameter("type") == null) {
            ...
            }else if (request.getAttribute("PRIVATE_NOTIFICATION_DETAIL") == null) {
                response.sendRedirect("MainController?action=Search&type=Notification&search=");
            } else {%>
        <div class="container">
            <header>${requestScope.PRIVATE_NOTIFICATION_DETAIL.notiHeader}</header>

            <form action="MainController" method="POST" enctype="multipart/form-data">
                <div class="form first">
                    <div class="details personal">
                        <span class="title">Private Notification Details</span>
