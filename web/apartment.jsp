                    ...
                    <div class="navbar-brand">
                        <a href="dashboard.jsp" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="assets/images/logo1.png" alt="homepage" class="dark-logo my_image"  />
                                <!-- Light Logo icon -->
                                <img src="assets/images/logo1.png" alt="homepage" class="light-logo my_image"/>
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>0123456789</td>
                                        <td>123 ÄÆ°á»ng 456 quáº­n 789 TP.HCM</td>
                                        <td>12/02/2002</td>
                                        <td>0112345678</td>
                                        <td>Male</td>
                                        <td>***</td>
