        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="index.jsp" class="text-white h2 mb-0"><strong>Apart<span class="text-primary">.</span></strong></a></h1>
            </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">Marga Luxury Suite</h1>
          <p>$6,200/night</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
      <div class="featured-property-half d-flex">
        ...
        <div class="text">
          ...
          <p><a href="contact.jsp" class="btn btn-primary px-4 py-3">Contact Us</a></p>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="100">
            <a href="apartment-detail.jsp" class="unit-9">
