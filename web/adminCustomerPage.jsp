...
<html lang="en">
    ...
    <body>
        <%if (request.getAttribute("USER_LIST") == null) {
                response.sendRedirect("MainController?action=Search&type=Customer&search=");
            }%>
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="MainController?type=Customer&action=Search&search=" class="active">
                        <i class='bx bx-user' ></i>
            ...
            <div class="home-content">
                ...
                <div class="sales-boxes">
                    <div class="recent-sales box">
                        <div class="title" style="float:left">CUSTOMER</div>
                        <a href="adminAddUserPage.jsp?type=Customer"style="float:right" >
                        ...
                        <table border="1" id="table">
                            ...
                            <form action="MainController" method="POST">
                                ...
                                <input type="hidden" name="type" value="Customer" readonly="readonly"/>
